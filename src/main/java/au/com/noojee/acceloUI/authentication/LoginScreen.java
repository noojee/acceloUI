...
public class LoginScreen extends CssLayout implements AuthListener<Person>
{
	...
	private Component buildLoginForm()
	{
		...
		loginForm.addComponent(username = new TextField("Email", "bsutton@noojee.com.au"));
	...
	@Override
	public void onAuthenticated(Person entity)
	{
		Person.Email email = entity.getEmails().get(0);
		
		Staff staff = new StaffDao().getByEmail(email.getValue());
	...
	{
		Notification.show("Login failed", error, Notification.Type.ERROR_MESSAGE);
